...
// pub trait TResponse<'r,'c>: std::io::Write
// where 'c: 'r
// {
...
// //     fn method(&self) -> anyhow::Result<Method>;
// //     fn uri(&self) -> String;
...
//     type Request<'rr, 'cc>: TRequest<'r, 'c>;
...
//     ) -> anyhow::Result<()>
//     where
//         F: for<'rr, 'cc> Fn(Self::Request<'rr, 'cc>) -> anyhow::Result<()> + Send + Sync + 'static;
